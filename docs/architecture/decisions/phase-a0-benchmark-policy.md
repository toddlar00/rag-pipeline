...
quick wins over the domain-gate refactor head `71b4a23`, whose own pair
passed both hosted Phase A0 cells on the post-merge `main` workflow at
evidence head `6efe0bc` — and separate Windows and Linux CPython 3.12.13
x86-64 reports. Both were generated under the
...
normalization, and the two-lane CI split precede `3b2188c` and were
...
merge `71b4a23` passed its cells at evidence head `6efe0bc`, and the
ingestion quick-wins merge `3b2188c` changes Python source again and
supersedes its pair in turn. The current inventory records
2,616 functions across 166 tracked sources with 951 static and 959 runtime
`rag` bindings. After strict synchronization and dependency checks for 189
Windows
and 187 Linux distributions, the Windows replacement report is 50,424 bytes
under CPython 3.12.13 (file SHA-256
`e1724f6d7ffae9391fdcf9c6619805b20995e180a8c1c7954474e6eb9137ae9c`;
embedded report SHA-256
`311b2cf347da1f1ee8d066929ad7b2891525cc7c6a6654fe17e5401b6d6296be`).
The Linux report is 49,821 bytes under CPython 3.12.13 (file SHA-256
`53ca22195943ef3e1a8dec69946bbaa3e537c2c16832799a77de9900ccd81eac`;
embedded report SHA-256
`ab83e97cfbfd1b2ee3d5789ea47b16d9fd5892887f25a115c9c908ad8a9ec201`).
