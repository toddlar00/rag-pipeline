...
now exists as the minimum R7 characterization gate. This implementation
merged to `main` on 2026-08-01 through the history-preserving integration of
cumulative PR #44; it has not been tagged or released.
